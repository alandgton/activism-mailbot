...
In light of recent events, I have created this Python script to send emails to a list of 386 elected US officials.
...
- Option 1: Use Docker (**RECOMMENDED**)
	...
	- Install docker-engine
    	- [Mac or Windows](https://docs.docker.com/engine/install/) ( Windows 10 Pro, Enterprise, and Education)
...
1. Choose which officials you would like to send emails to
	- Enter the number corresponding to the state/city/county of your choice
		- Enter 0 to Select All (current total: 386 recipients)
